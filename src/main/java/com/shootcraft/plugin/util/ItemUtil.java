...
/**
 * Construit les objets du kit ShootCraft : le baton magique (tir au clic droit,
 * boost de vitesse au clic gauche) et l'item pour quitter la partie.
 *
 * On identifie ces items par leur nom affiche + un lore marqueur (pas de NBT
 * custom ici pour rester simple), verifie par WandListener.
 */
public final class ItemUtil {
    ...
    public static ItemStack buildWand() {
        ...
        meta.setLore(List.of(
                ChatColor.GRAY + "Clic droit : tirer un rayon magique",
                ChatColor.GRAY + "sur tes adversaires !",
                ChatColor.GRAY + "Clic gauche : boost de vitesse",
